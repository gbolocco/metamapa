...
public class UsuarioRepositoryMemory implements WithSimplePersistenceUnit {

  private static final UsuarioRepositoryMemory instance = new UsuarioRepositoryMemory();

  public static UsuarioRepositoryMemory getInstance() {
    return instance;
  }
